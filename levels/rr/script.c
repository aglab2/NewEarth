...
const LevelScript level_rr_entry[] = {
	...
	AREA(1, rr_area_1),
		...
		WARP_NODE(205, LEVEL_RR, 0x01, 0xaa, WARP_NO_CHECKPOINT),
		...
		OBJECT(0, 1398, 9470, 5995, 0, 0, 0, (205 << 16), bhvFadingWarp),
		OBJECT(0, 1398, 9470, 5995, 0, 0, 0, (205 << 16), bhvEmitter_MOP),

...
void scroll_jrb_dl_DL_jrb_1_0xe01a8f8_Obj_mesh_layer_5_vtx_0() {
	int i = 0;
	int count = 8;
	int height = 32 * 0x20;
	...
	static int currentY = 0;
	int deltaY;
	Vtx *vertices = segmented_to_virtual(jrb_dl_DL_jrb_1_0xe01a8f8_Obj_mesh_layer_5_vtx_0);
...
void scroll_jrb() {
	...
	scroll_jrb_dl_DL_jrb_1_0xe01a8f8_Obj_mesh_layer_5_vtx_0();

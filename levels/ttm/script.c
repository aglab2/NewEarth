...
const LevelScript level_ttm_entry[] = {
	...
	LOAD_MIO0(0xa, _c12_skybox_mio0SegmentRomStart, _c12_skybox_mio0SegmentRomEnd), 
	...
	AREA(1, ttm_area_1),
		...
		OBJECT(0, -21, 7222, 117, 0, 0, 0, 0x0, Bhv_Custom_0x13005778),
		OBJECT(0, -4122, 6397, -3788, 0, 0, 0, 0x0, Bhv_Custom_0x13005778),
		OBJECT(0, -2369, 6498, 4243, 0, 0, 0, 0x0, Bhv_Custom_0x13005778),
		OBJECT(0, 5067, 6360, 4516, 0, 0, 0, 0x0, Bhv_Custom_0x13005778),
		OBJECT(0, 4767, 6377, -1553, 0, 0, 0, 0x0, Bhv_Custom_0x13005778),
		...
		OBJECT(0, -3740, 3779, -3113, 0, 0, 0, 0x3000000, bhvHiddenRedCoinStar),
		OBJECT(0, -1876, 7345, 2066, 0, 0, 0, 0x4000000, bhvHiddenStar),
		OBJECT(0, -21, 7222, 117, 0, 0, 0, 0x0, bhvHiddenStarTrigger),
		OBJECT(0, -4122, 6397, -3788, 0, 0, 0, 0x0, bhvHiddenStarTrigger),
		OBJECT(0, -2369, 6498, 4243, 0, 0, 0, 0x0, bhvHiddenStarTrigger),
		OBJECT(0, 5067, 6360, 4516, 0, 0, 0, 0x0, bhvHiddenStarTrigger),
		OBJECT(0, 4767, 6377, -1553, 0, 0, 0, 0x0, bhvHiddenStarTrigger),

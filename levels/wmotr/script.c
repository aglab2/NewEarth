...
const LevelScript level_wmotr_entry[] = {
	...
	AREA(1, wmotr_area_1),
		...
		WARP_NODE(10, LEVEL_CASTLE_GROUNDS, 1, 50, WARP_NO_CHECKPOINT),
		...
		OBJECT(122, 185, 1494, 1940, 0, 0, 0, 0x0000000, bhvStar),
		OBJECT(122, 5874, 2901, 3749, 0, 0, 0, 0x1000000, bhvStar),
		OBJECT(122, -353, 5281, -1260, 0, 0, 0, 0x2000000, bhvStar),

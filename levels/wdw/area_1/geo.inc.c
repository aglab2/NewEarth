...
const GeoLayout wdw_area_1_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_OPEN_NODE(),
			GEO_CULL(-32000, 32000, -32000, 32000, -8000, 32000, 0),
			GEO_OPEN_NODE(),
				GEO_DISPLAY_LIST(LAYER_OPAQUE, wdw_dl_c_001_mesh_layer_1),
			GEO_CLOSE_NODE(),
		GEO_CLOSE_NODE(),
		...
		GEO_OPEN_NODE(),
			GEO_CULL(-32000, 32000, -32000, 32000, -8000, 32000, 0),
			GEO_OPEN_NODE(),
				GEO_DISPLAY_LIST(LAYER_OPAQUE, wdw_dl_c1_mesh_layer_1),
			GEO_CLOSE_NODE(),
		GEO_CLOSE_NODE(),
		GEO_ROTATION_NODE_WITH_DL(LAYER_OPAQUE, 90, 0, 0, wdw_dl_DL_wdw_1_0xe0459e0_Obj_mesh_layer_1),
		GEO_ROTATION_NODE_WITH_DL(LAYER_TRANSPARENT, 90, 0, 0, wdw_dl_DL_wdw_1_0xe054830_Obj_mesh_layer_5),

...
void scroll_ttc_dl_DL_ttc_1_0xe044680_Obj_006_mesh_layer_1_vtx_1() {
	int i = 0;
	int count = 12;
	int height = 32 * 0x20;
	...
	static int currentY = 0;
	int deltaY;
	Vtx *vertices = segmented_to_virtual(ttc_dl_DL_ttc_1_0xe044680_Obj_006_mesh_layer_1_vtx_1);
...
void scroll_ttc() {
	...
	scroll_ttc_dl_DL_ttc_1_0xe044680_Obj_006_mesh_layer_1_vtx_1();

...
const GeoLayout bitdw_area_1_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_ROTATION_NODE_WITH_DL(LAYER_TRANSPARENT, 90, 0, 0, bitdw_dl_DL_bitdw_1_0xe03f170_Obj_mesh_layer_5),
		GEO_OPEN_NODE(),
			GEO_DISPLAY_LIST(LAYER_OPAQUE, bitdw_dl_DL_bitdw_1_0xe03f170_Obj_mesh_layer_1),
		GEO_CLOSE_NODE(),

...
const LevelScript level_bitfs_entry[] = {
	...
	AREA(1, bitfs_area_1),
		...
		OBJECT(0, 9415, 4734, 16311, 0, 0, 0, 0x0, bhvBowserCourseRedCoinStar),
		OBJECT(0, -3630, 240, -2296, 0, 90, 0, 0x40000, bhvCoinFormation),
		OBJECT(0, -1382, 720, -1573, 0, 0, 0, 0x0, bhvCoinFormation),
		OBJECT(0, 1554, 960, -1104, 0, 135, 0, 0x40000, bhvCoinFormation),
		OBJECT(0, 3820, 720, -1043, 0, 0, 0, 0x20000, bhvCoinFormation),
		OBJECT(0, 2683, 1050, 3211, 0, 0, 0, 0x110000, bhvCoinFormation),
		OBJECT(0, 6653, 2640, 3472, 0, 0, 0, 0x110000, bhvCoinFormation),
		OBJECT(0, 7140, 3120, 2518, 0, 0, 0, 0x110000, bhvCoinFormation),
		OBJECT(0, 4616, 720, -2392, 0, 0, 0, 0x40000, bhvCoinFormation),
		OBJECT(0, 3774, 720, 228, 0, 90, 0, 0x0, bhvCoinFormation),
		OBJECT(0, 8580, 3360, 3717, 0, 0, 0, 0x20000, bhvCoinFormation),
		OBJECT(0, 8594, 3360, 4776, 0, 90, 0, 0x0, bhvCoinFormation),
		OBJECT(0, 8580, 3840, 10071, 0, 90, 0, 0x0, bhvCoinFormation),
		OBJECT(0, 8223, 4800, 15815, 0, 0, 0, 0x1e0000, bhvDeathWarp),
		OBJECT(124, -3901, 240, -2727, 0, 0, 0, 0x4f0000, bhvMessagePanel),
		OBJECT(215, 8813, 4568, 16426, 0, 0, 0, 0x0, bhvRedCoin),
		OBJECT(215, 7492, 4320, 8632, 0, 0, 0, 0x0, bhvRedCoin),
		OBJECT(215, 9057, 2640, 2029, 0, 0, 0, 0x0, bhvRedCoin),
		OBJECT(215, 3763, 2476, 6474, 0, 0, 0, 0x0, bhvRedCoin),
		OBJECT(215, 5222, 1399, 1911, 0, 0, 0, 0x0, bhvRedCoin),
		OBJECT(215, 6174, 1680, -612, 0, 0, 0, 0x0, bhvRedCoin),
		OBJECT(215, 775, 240, -2404, 0, 0, 0, 0x0, bhvRedCoin),
		OBJECT(215, -4503, 960, -489, 0, 0, 0, 0x0, bhvRedCoin),
		OBJECT(0, -4360, 240, -2296, 0, 90, 0, 0xa0000, bhvSpinAirborneWarp),
		OBJECT(0, -5100, 240, -2292, 0, 90, 0, 0x1e280000, bhvWarp),
		OBJECT(22, 7730, 4800, 16312, 0, 0, 0, 0x140000, bhvWarpPipe),

void scroll_sa_dl_DL_sa_1_0xe03f590_Obj_mesh_layer_1_vtx_0() {
	int i = 0;
	int count = 75;
	int height = 32 * 0x20;
	...
	int deltaY;
	Vtx *vertices = segmented_to_virtual(sa_dl_DL_sa_1_0xe03f590_Obj_mesh_layer_1_vtx_0);
...
void scroll_sa_dl_DL_sa_1_0xe03f590_Obj_mesh_layer_1_vtx_15() {
	int i = 0;
	int count = 65;
	int width = 32 * 0x20;
	...
	int deltaX;
	Vtx *vertices = segmented_to_virtual(sa_dl_DL_sa_1_0xe03f590_Obj_mesh_layer_1_vtx_15);
...
void scroll_sa_dl_DL_sa_1_0xe03f590_Obj_mesh_layer_1_vtx_38() {
	int i = 0;
	int count = 61;
	int height = 32 * 0x20;
	...
	static int currentY = 0;
	int deltaY;
	Vtx *vertices = segmented_to_virtual(sa_dl_DL_sa_1_0xe03f590_Obj_mesh_layer_1_vtx_38);

	deltaY = (int)(-0.13999995589256287 * 0x20) % height;
...
void scroll_sa_dl_DL_sa_1_0xe03f590_Obj_mesh_layer_1_vtx_56() {
	int i = 0;
	int count = 52;
	int width = 32 * 0x20;
	...
	static int currentX = 0;
	int deltaX;
	Vtx *vertices = segmented_to_virtual(sa_dl_DL_sa_1_0xe03f590_Obj_mesh_layer_1_vtx_56);
...
void scroll_sa_dl_DL_sa_1_0xe03f590_Obj_mesh_layer_1_vtx_66() {
	int i = 0;
	int count = 622;
	int height = 32 * 0x20;
	...
	static int currentY = 0;
	int deltaY;
	Vtx *vertices = segmented_to_virtual(sa_dl_DL_sa_1_0xe03f590_Obj_mesh_layer_1_vtx_66);
...
void scroll_sa_dl_DL_sa_4_0xe004180_Obj_mesh_layer_1_vtx_3() {
	...
	deltaY = (int)(0.10000003129243851 * 0x20) % height;
...
void scroll_sa_dl_DL_sa_5_0xe02bc60_Obj_mesh_layer_1_vtx_27() {
	int i = 0;
	int count = 317;
	int height = 64 * 0x20;
	...
	static int currentY = 0;
	int deltaY;
	Vtx *vertices = segmented_to_virtual(sa_dl_DL_sa_5_0xe02bc60_Obj_mesh_layer_1_vtx_27);
...
void scroll_sa_dl_DL_sa_5_0xe02bc60_Obj_mesh_layer_1_vtx_37() {
	int i = 0;
	int count = 502;
	int height = 32 * 0x20;
	...
	static int currentY = 0;
	int deltaY;
	Vtx *vertices = segmented_to_virtual(sa_dl_DL_sa_5_0xe02bc60_Obj_mesh_layer_1_vtx_37);
...
void scroll_sa_dl_SR5__1__001_mesh_layer_1_vtx_2() {
	int i = 0;
	int count = 11;
	int height = 32 * 0x20;
	...
	static int currentY = 0;
	int deltaY;
	Vtx *vertices = segmented_to_virtual(sa_dl_SR5__1__001_mesh_layer_1_vtx_2);
...
void scroll_sa() {
	scroll_sa_dl_DL_sa_1_0xe03f590_Obj_mesh_layer_1_vtx_0();
	scroll_sa_dl_DL_sa_1_0xe03f590_Obj_mesh_layer_1_vtx_15();
	scroll_sa_dl_DL_sa_1_0xe03f590_Obj_mesh_layer_1_vtx_38();
	scroll_sa_dl_DL_sa_1_0xe03f590_Obj_mesh_layer_1_vtx_56();
	scroll_sa_dl_DL_sa_1_0xe03f590_Obj_mesh_layer_1_vtx_66();
	...
	scroll_sa_dl_DL_sa_5_0xe02bc60_Obj_mesh_layer_1_vtx_27();
	scroll_sa_dl_DL_sa_5_0xe02bc60_Obj_mesh_layer_1_vtx_37();
	scroll_sa_dl_SR5__1__001_mesh_layer_1_vtx_2();
};

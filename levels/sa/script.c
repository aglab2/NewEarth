...
const LevelScript level_sa_entry[] = {
	...
	AREA(2, sa_area_2),
		...
		OBJECT(38, 18603, 7808, -10858, 0, 90, 0, 0x140000, bhvDoorWarp),
		OBJECT(137, 1831, 3983, -11901, 0, 0, 0, 0x30000, bhvExclamationBox),
		OBJECT(207, -229, 1387, -5015, 0, 0, 0, 0x0, bhvFloorSwitchHiddenObjects),
		OBJECT(129, 0, 1446, -7113, 0, 0, 0, 0x0, bhvHiddenObject),
		OBJECT(129, 0, 1646, -7513, 0, 0, 0, 0x0, bhvHiddenObject),
		OBJECT(129, 0, 1846, -7913, 0, 0, 0, 0x0, bhvHiddenObject),
		OBJECT(129, 0, 2278, -9490, 0, 0, 0, 0x0, bhvHiddenObject),
		OBJECT(129, 0, 2678, -9890, 0, 0, 0, 0x0, bhvHiddenObject),
		OBJECT(129, 0, 3078, -10290, 0, 0, 0, 0x0, bhvHiddenObject),
		OBJECT(0, 9512, 7462, -7905, 0, 0, 0, 0xff0000, bhvPoleGrabbing),
		OBJECT(0, 8594, 7528, -8921, 0, 0, 0, 0xff0000, bhvPoleGrabbing),
		OBJECT(22, -12, 787, -1521, 0, -180, 0, 0xa0000, bhvWarpPipe),
	...
	AREA(5, sa_area_5),
		...
		OBJECT(38, 7771, 8816, 1279, 0, 90, 0, 0x0, bhvDoor),
		OBJECT(38, 7771, 8816, 278, 0, 90, 0, 0x1e0000, bhvDoorWarp),
		OBJECT(38, 7771, 8816, 780, 0, 90, 0, 0x1e0000, bhvDoorWarp),
		OBJECT(38, 7771, 8816, 1780, 0, 90, 0, 0x1e0000, bhvDoorWarp),

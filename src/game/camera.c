...
u8 sZoomOutAreaMasks[] = {
	...
	ZOOMOUT_AREA_MASK(1, 1, 1, 0, 1, 1, 1, 0), // CASTLE_INSIDE  | HMC
	ZOOMOUT_AREA_MASK(1, 1, 1, 0, 1, 0, 0, 0), // SSL            | BOB
	ZOOMOUT_AREA_MASK(1, 1, 1, 0, 1, 1, 1, 0), // SL             | WDW
	ZOOMOUT_AREA_MASK(1, 1, 1, 1, 1, 1, 0, 0), // JRB            | THI
	ZOOMOUT_AREA_MASK(1, 1, 1, 1, 1, 0, 0, 0), // TTC            | RR
	...
	ZOOMOUT_AREA_MASK(1, 1, 1, 1, 0, 0, 0, 0), // COURTYARD      | PSS
	ZOOMOUT_AREA_MASK(1, 1, 0, 0, 1, 0, 0, 0), // COTMC          | TOTWC
	ZOOMOUT_AREA_MASK(1, 0, 0, 0, 1, 0, 0, 0), // BOWSER_1       | WMOTR
	ZOOMOUT_AREA_MASK(0, 0, 0, 0, 1, 0, 0, 0), // Unused         | BOWSER_2
	ZOOMOUT_AREA_MASK(1, 0, 0, 0, 0, 0, 0, 0), // BOWSER_3       | Unused
	ZOOMOUT_AREA_MASK(1, 1, 1, 0, 0, 0, 0, 0), // TTM            | Unused
	ZOOMOUT_AREA_MASK(0, 0, 0, 0, 0, 0, 0, 0), // Unused         | Unused
};
